    ...
    <body>
        ...
        <div class="site-wrapper">
            ...
            <div class="site-wrapper-inner">
                ...
                <div class="cover-container">
                    ...
                    <br>
                        <div class="lead row">
                                ...
                                <div class="input-group">
                                    <input type="text" placeholder="Search by..." id="searchInputField" class="form-control">
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-default dropdown-toggle" id="dropDownButton" data-toggle="dropdown">Instructor<span class="caret"></span></button>
                            ...
                            <div class="col-lg-2">
                                <button type="button" class="btn btn-info" id="searchButton" style="margin-left:-100px;">
                    ...
                    <!-- Standard button -->
                    <button type="button" class="btn btn-default-selected" id="bestClassesButton">Best Classes</button>
                    <button type="button" class="btn btn-primary" id="bestTeachersButton">Best Instructors</button>
                    <button type="button" class="btn btn-primary" id="easiestClassesButton">Easy-A</button>
                    ...
                    ?>
                        ...
                        <!-- Easiest Classes -->
                        <table class="table text-left table-bordered" id="easiestClassesTable" style="display:none;">
                            <tr>
                                <th>Class Name</th>
                                <th>Department</th>
                                <th>Instructor</th>
                ...
                <div class="container">
                    <p class="lead"> Take a look at your friend's favorite professors and classes...</p>
